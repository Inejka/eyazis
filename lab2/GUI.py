...
class GUI:
    ...
    def init_main_window(self):
        ...
        analyze_button.clicked.connect(lambda : analyse(self.plain_text.toPlainText()))
    ...
    Делает дерево синтаксического разбора предложения.

    Поддерживаемые форматы входных текстовых файлов - doc.
    
    Для сохранения дерева синтаксического разбора File->Save в окне синтаксического разбора.
